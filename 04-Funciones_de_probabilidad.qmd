...
```{r}
ride_filtered |> filter(Activity.Name %in% c('Morning Ride', 'Afternoon Ride', 'Evening Ride')) |> ggplot(aes(y=Moving.Minutes, fill=Activity.Name))+geom_boxplot()
```
...
print(paste("METODO 2: La probabilidad de recibir exactamente",
            k,"llamadas en un minuto es:",dpois(5, lambda=2  )))
```
